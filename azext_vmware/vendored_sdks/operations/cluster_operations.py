...
class ClusterOperations(object):
    ...
    def list(
        ...
        :rtype: list[~vendored_sdks.models.AzureClusterResponse] or
    ...
    def create(
            self, resource_group_name, private_cloud_name, cluster_name, parameters, custom_headers=None, raw=False, **operation_config):
        """create cluster.
        ...
        :type cluster_name: str
        :param parameters:
        :type parameters: ~vendored_sdks.models.AzureClusterRequest
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
